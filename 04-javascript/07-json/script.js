...
/* 
    ...
    C'est un langage qui permet de transformer des données complexe comme un tableau ou un objet en string. 
    Cela peut servir pour sauvegarder des données sous forme de string mais aussi pour transférer des données entre différents langages.
